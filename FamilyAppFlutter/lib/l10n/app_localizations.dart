...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    ...
    'triggerTestCrashTitle': {
      'en': 'Send test crash',
      'ru': 'Отправить тестовый краш',
      'de': 'Testabsturz auslösen',
      'fr': 'Déclencher un crash test',
      'es': 'Enviar crash de prueba',
      'zh': '发送测试崩溃',
    },
    'triggerTestCrashSubtitle': {
      'en': 'Crashes the app to verify Crashlytics reporting.',
      'ru': 'Принудительно завершит приложение для проверки Crashlytics.',
      'de': 'Löst einen Absturz aus, um die Crashlytics-Erfassung zu prüfen.',
      'fr': 'Provoque un plantage pour vérifier Crashlytics.',
      'es': 'Provoca un cierre para comprobar Crashlytics.',
      'zh': '触发崩溃以验证 Crashlytics 报告。',
    },
    'triggerTestCrashConfirm': {
      'en': 'Crash now',
      'ru': 'Крашнуть сейчас',
      'de': 'Jetzt abstürzen',
    ...
    'galleryUploadProgressLabel': {
      'en': 'Uploading… {progress}%',
      'ru': 'Загрузка… {progress}%',
      'de': 'Hochladen… {progress}%',
      'fr': 'Téléversement… {progress} %',
      'es': 'Subiendo… {progress}%',
      'zh': '正在上传… {progress}%',
    },
    'galleryUploadFailed': {
      'en': 'Upload failed. Check your connection and try again.',
      'ru': 'Не удалось загрузить. Проверьте соединение и повторите попытку.',
      'de': 'Hochladen fehlgeschlagen. Prüfen Sie die Verbindung und versuchen Sie es erneut.',
      'fr': 'Échec du téléversement. Vérifiez votre connexion et réessayez.',
      'es': 'Error al subir. Verifique la conexión e inténtelo de nuevo.',
      'zh': '上传失败。请检查连接并重试。',
    },
    'galleryRetryUpload': {
      'en': 'Retry upload',
    ...
    'galleryCaptionHint': {
      'en': 'Add a short note about this memory',
      'ru': 'Добавьте небольшую заметку об этом воспоминании',
      'de': 'Fügen Sie eine kurze Notiz zu dieser Erinnerung hinzu',
      'fr': 'Ajoutez une courte note sur ce souvenir',
      'es': 'Agregue una nota breve sobre este recuerdo',
      'zh': '为这段回忆添加一句话',
    },
    'galleryFileSizeLabel': {
      'en': 'File size: {size}',
      'ru': 'Размер файла: {size}',
      'de': 'Dateigröße: {size}',
      'fr': 'Taille du fichier : {size}',
      'es': 'Tamaño del archivo: {size}',
      'zh': '文件大小：{size}',
    },
    'galleryDeleteNotAllowed': {
      'en': 'You do not have permission to remove this item.',
      'ru': 'У вас нет прав для удаления этого элемента.',
      'de': 'Sie haben keine Berechtigung, dieses Element zu löschen.',
      'fr': 'Vous n’avez pas l’autorisation de supprimer cet élément.',
      'es': 'No tienes permiso para eliminar este elemento.',
      'zh': '您无权删除此项目。',
    },
    'galleryEmpty': {
    ...
    'galleryMissingMedia': {
      'en': 'The media file is unavailable.',
      'ru': 'Медиафайл недоступен.',
      'de': 'Die Mediendatei ist nicht verfügbar.',
      'fr': 'Le fichier média est indisponible.',
      'es': 'El archivo multimedia no está disponible.',
      'zh': '媒体文件不可用。',
    },
    'galleryVideoFailed': {
      'en': 'Unable to play this video.',
      'ru': 'Не удалось воспроизвести видео.',
      'de': 'Dieses Video kann nicht abgespielt werden.',
    ...
    'taskTimeReminderToggle': {
      'en': 'Due date reminder',
      'ru': 'Напоминание о сроке',
      'de': 'Fälligkeits-Erinnerung',
      'fr': "Rappel d'échéance",
      'es': 'Recordatorio de fecha límite',
      'zh': '截止提醒',
    },
    'taskTimeReminderDescription': {
      'en': 'Schedule a notification when the task is due.',
      'ru': 'Показывать уведомление, когда подходит срок задачи.',
      'de': 'Benachrichtigung zum Fälligkeitszeitpunkt senden.',
      'fr': 'Programmer une notification à la date limite.',
      'es': 'Programar una notificación para la fecha límite.',
      'zh': '在任务到期时发送通知。',
    },
    'taskGeoReminderToggle': {
      'en': 'Location reminder',
      'ru': 'Напоминание по геолокации',
      'de': 'Standorterinnerung',
      'fr': 'Rappel géolocalisé',
      'es': 'Recordatorio por ubicación',
      'zh': '位置提醒',
    },
    'taskGeoReminderDescription': {
      'en': 'Alert me when I arrive near this place.',
      'ru': 'Уведомлять при приближении к месту задачи.',
      'de': 'Benachrichtigen, wenn ich in der Nähe bin.',
      'fr': 'Me prévenir lorsque j’arrive près de ce lieu.',
      'es': 'Avisarme al llegar cerca de este lugar.',
      'zh': '靠近此地点时提醒我。',
    },
    'taskLocationLabel': {
      'en': 'Location',
    ...
    'taskGeoReminderMissingLocation': {
      'en': 'Set a location before enabling the geo reminder.',
      'ru': 'Укажите место перед включением гео-напоминания.',
      'de': 'Ort festlegen, bevor die Standort-Erinnerung aktiviert wird.',
      'fr': 'Définissez un lieu avant d’activer le rappel géolocalisé.',
      'es': 'Defina una ubicación antes de activar el recordatorio geográfico.',
      'zh': '启用地理提醒前请先设置地点。',
    },
    'locationPermissionDeniedMessage': {
      'en': 'Allow location access in Android settings to use geo reminders.',
      'ru': 'Разрешите доступ к геолокации в настройках Android для гео-напоминаний.',
      'de': 'Erlaube den Standortzugriff in den Android-Einstellungen für Geo-Erinnerungen.',
      'fr': 'Autorisez l’accès à la localisation dans les réglages Android pour activer les rappels.',
      'es': 'Permite el acceso a la ubicación en los ajustes de Android para usar recordatorios geográficos.',
      'zh': '请在安卓设置中授予位置权限以使用地理提醒。',
    },
    'taskReminderActiveLabel': {
      'en': 'Due reminder enabled',
      'ru': 'Напоминание о сроке включено',
      'de': 'Fälligkeits-Erinnerung aktiv',
      'fr': "Rappel d'échéance activé",
      'es': 'Recordatorio de fecha límite activado',
      'zh': '截止提醒已启用',
    },
    'taskRadiusMeters': {
      'en': 'Radius: {meters} m',
    ...
    'eventLocationHint': {
      'en': 'e.g. School gym',
      'ru': 'например, школьный спортзал',
      'de': 'z. B. Turnhalle',
      'fr': 'ex. gymnase',
      'es': 'ej. gimnasio escolar',
      'zh': '例如：学校体育馆',
    },
    'eventReminderToggle': {
      'en': 'Event reminder',
    ...
    'eventReminderDescription': {
      'en': 'Receive an alert before the event starts.',
      'ru': 'Получать напоминание перед началом события.',
      'de': 'Benachrichtigung vor Beginn des Termins erhalten.',
      'fr': 'Recevoir une alerte avant le début de l’événement.',
      'es': 'Recibir una alerta antes de que empiece el evento.',
      'zh': '活动开始前收到提醒。',
    },
    'eventReminderMinutesLabel': {
      'en': 'Remind me',
      'ru': 'Напомнить за',
      'de': 'Erinnern nach',
      'fr': 'Me rappeler',
    ...
    'eventGeoReminderToggle': {
      'en': 'Location arrival alert',
      'ru': 'Напоминание при приближении',
      'de': 'Alarm bei Ankunft',
      'fr': 'Alerte à l’arrivée',
      'es': 'Alerta al llegar',
      'zh': '到达提醒',
    },
    'eventGeoReminderDescription': {
      'en': 'Notify me when I reach this location.',
      'ru': 'Уведомлять при прибытии на место события.',
      'de': 'Benachrichtigen, wenn ich den Ort erreiche.',
      'fr': 'Me prévenir lorsque j’arrive sur le lieu.',
      'es': 'Avisarme al llegar a esta ubicación.',
      'zh': '到达该地点时提醒我。',
    },
    'eventGeoReminderMissingLocation': {
      'en': 'Set an event location before enabling the geo reminder.',
      'ru': 'Укажите место события перед включением гео-напоминания.',
      'de': 'Ort des Ereignisses festlegen, bevor die Geo-Erinnerung aktiviert wird.',
      'fr': 'Définissez un lieu avant d’activer le rappel géolocalisé.',
      'es': 'Define una ubicación antes de activar el recordatorio geográfico.',
      'zh': '启用地理提醒前请设置事件地点。',
    },
    'eventReminderMinutes': {
      'en': 'Reminder {minutes} minutes before',
      'ru': 'Напоминание за {minutes} минут',
      'de': 'Erinnerung {minutes} Minuten vorher',
      'fr': 'Rappel {minutes} minutes avant',
      'es': 'Recordatorio {minutes} minutos antes',
      'zh': '提前 {minutes} 分钟提醒',
    },
    'minutesBefore': {
      'en': '{minutes} minutes before',
      'ru': 'за {minutes} минут',
      'de': '{minutes} Minuten vorher',
      'fr': '{minutes} minutes avant',
      'es': '{minutes} minutos antes',
      'zh': '提前 {minutes} 分钟',
    },
    'deleteEventAction': {
      'en': 'Delete event',
  ...
  String taskRadiusMeters(int meters) =>
      translateWithParams('taskRadiusMeters', {'meters': '$meters'});

  String minutesBefore(int minutes) =>
      translateWithParams('minutesBefore', {'minutes': '$minutes'});

  String eventReminderMinutes(int minutes) =>
      translateWithParams('eventReminderMinutes', {'minutes': '$minutes'});
}
