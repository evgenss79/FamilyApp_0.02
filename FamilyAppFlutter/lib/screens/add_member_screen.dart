      ...
      children: [
        ...
        Expanded(
          ...
          child: DropdownButtonFormField<String>(
            value: entry['type'],
            decoration:
                const InputDecoration(isDense: true, labelText: 'Type'),
            items: types
        ...
        Expanded(
          ...
          child: TextFormField(
            ...
            decoration:
                const InputDecoration(isDense: true, labelText: 'Value'),
            onChanged: (val) {
              entry['value'] = val;
            },
          ),
        ...
        child: ListView(
          ...
          children: [
            ...
            ...List.generate(
              ...
              (i) =>
                  _buildEntryRow(_documentEntries, i, _documentTypes, setState),
            ),
            Align(
            ...
            ...List.generate(
              ...
              (i) =>
                  _buildEntryRow(_socialEntries, i, _socialTypes, setState),
            ),
            Align(
              alignment: Alignment.centerLeft,
              child: TextButton.icon(
